...
export const INITIAL_MEDICATIONS: Medication[] = [
  {
    id: '1',
    name: 'Amlodipine',
    commonName: 'ยาลดความดัน',
    appearance: 'เม็ดสีขาว รูปหัวใจ',
    dosage: '5mg',
    time: '08:00',
  ...
  },
  {
    id: '2',
    name: 'Metformin',
    commonName: 'ยาเบาหวาน',
    appearance: 'เม็ดรี สีขาว',
    dosage: '500mg',
    time: '12:00',
    instruction: 'พร้อมอาหารเที่ยง',
    taken: false,
    type: 'pills',
  ...
  },
  {
    id: '3',
    name: 'Simvastatin',
    commonName: 'ยาลดไขมัน',
    appearance: 'เม็ดสีเหลือง',
    dosage: '20mg',
    time: '20:00',
    instruction: 'ก่อนนอน',
    taken: false,
